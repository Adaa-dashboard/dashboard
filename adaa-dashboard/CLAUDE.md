...
## م1 — الاستراتيجيات (منطق خاص)
- `recalcStrategies()` تحسب عمودي **الحالة** و**الأيام** من التواريخ، وتُستدعى في
  `loadFromCloud()` و`renderDetails()` — العمودان للقراءة فقط في الجدول
...
- `renderStrategyExtras()` تعرض (لتبويب م1 فقط): بطاقات ملخص الحالات الأربع،
  قائمتَي «وصلت ولم تُرسل» و«قادمة متوقعة»، ودليل الحالات
