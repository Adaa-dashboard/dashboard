...
/* الأسماء المختصرة كما سمّتها المستخدمة، بترتيب صفحة «المؤشرات التفصيلية» */
const KPI_SHORT: { has: string[]; short: string }[] = [
  { has: ["خدمات"], short: "قياس خدمات الأجهزة العامة" },
  { has: ["منخفض"], short: "الأجهزة ذات الأداء المنخفض" },
  { has: ["مخرجات"], short: "المخرجات الوطنية" },
  { has: ["وزراء"], short: "الاستراتيجيات الوطنية" },
  { has: ["مؤسسي"], short: "الاستراتيجيات المؤسسية" },
  { has: ["تكليف"], short: "التكليفات" },
  { has: ["فردي"], short: "إتمام الخطة الفردية" },
