...
function answer(q0: string, c: Ctx): Ans {
  ...
  /* مساعدة — السؤال الفارغ لا يقع هنا: فتحُ المساعد يبدأ من
     «أهم ما عندك الآن»، والشرح خلف زر ⓘ */
  if (has(q, "مساعدة", "وش تقدر", "ماذا تستطيع", "الأوامر", "وش أقدر أسوي", "وش اقدر اسوي"))
    return HELP;
      ...
      {open && (
        <div className="modal-overlay" onClick={close}>
          <div className="modal ai" onClick={(e) => e.stopPropagation()}>
            ...
            {/* ⓘ: الأسئلة المقترحة والشرح معاً — لا يظهران إلا بطلبها */}
            {tips && (
              <div className="ai-help">
                ...
                {HELP.note && <div className="ai-note">{HELP.note}</div>}
              </div>
            )}
