...
export function buildWeekly2(
  ...
  /* «الأداء العام» أُزيل من التقرير بطلب مالكة المنصة: كان رقماً
     ثانياً بالاسم نفسه يخالف الرقم في «نظرة عامة» (ذاك يُحسب من
     القياسات والمستهدفات، وهذا من تقدّم الأقسام) فيلتبس على القارئ.
     الحساب باقٍ هنا غير معروض، حتى تُعتمد صيغة واحدة للاثنين. */
  const ratios: number[] = [];
