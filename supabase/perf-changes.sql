...
insert into public.perf_items (section, id, ord, data) values
 ('sessions','ses-1',1,'{"demo":true,"entity":"وزارة التعليم","quarter":"الربع الثالث ٢٠٢٦","done":4,"stages":[{"n":"تحديد الجهة","d":"2026-07-05"},{"n":"جمع البيانات","d":"2026-07-20"},{"n":"إعداد التقرير","d":"2026-08-02"},{"n":"انعقاد الجلسة","d":"2026-08-11"},{"n":"محضر وتوصيات","d":"2026-08-25"},{"n":"الإغلاق","d":""}]}'::jsonb),
 ('sessions','ses-2',2,'{"demo":true,"entity":"هيئة الحكومة الرقمية","quarter":"الربع الثالث ٢٠٢٦","done":2,"stages":[{"n":"تحديد الجهة","d":"2026-07-06"},{"n":"جمع البيانات","d":"2026-07-28"},{"n":"إعداد التقرير","d":""},{"n":"انعقاد الجلسة","d":""},{"n":"محضر وتوصيات","d":""},{"n":"الإغلاق","d":""}]}'::jsonb),
 ('sessions','ses-3',3,'{"demo":true,"entity":"وزارة النقل","quarter":"الربع الثالث ٢٠٢٦","done":6,"stages":[{"n":"تحديد الجهة","d":"2026-07-05"},{"n":"جمع البيانات","d":"2026-07-15"},{"n":"إعداد التقرير","d":"2026-07-30"},{"n":"انعقاد الجلسة","d":"2026-08-12"},{"n":"محضر وتوصيات","d":"2026-08-20"},{"n":"الإغلاق","d":"2026-08-28"}]}'::jsonb),
 ('sessions','ses-4',4,'{"demo":true,"entity":"وزارة البلديات والإسكان","quarter":"الربع الثالث ٢٠٢٦","done":0,"stages":[{"n":"تحديد الجهة","d":""},{"n":"جمع البيانات","d":""},{"n":"إعداد التقرير","d":""},{"n":"انعقاد الجلسة","d":""},{"n":"محضر وتوصيات","d":""},{"n":"الإغلاق","d":""}]}'::jsonb),

 ('natstrat','nat-1',1,'{"demo":true,"name":"الاستراتيجية الوطنية للتجارة الخارجية","owner":"وزارة التجارة","domain":"الاستثمار","stage":2,"tech":false,"meas":58,"note":"مخرجات غير قابلة للقياس ولم تُحدَّد مستهدفاتها","period":"٢٠٢٥ – ٢٠٣٠","approvedAt":"","kpisRep":11,"kpisTot":18,"initRep":19,"initTot":34,"current":"جارٍ العمل مع مالك الاستراتيجية لرفع مستوى قابلية القياس، وتُعدّ ضمن النطاق المنخفض بنسبة ٥٨٪.","challenge":"توجد عناصر في الاستراتيجية لم تستوفِ معايير المركز.","next":"العمل مع فريق الجهة لرفع قابلية القياس للوصول إلى ١٠٠٪.","support":"التأكيد على فريق الجهة بالمواءمة المستمرة مع مركز أداء.","updated":"2026-09-04"}'::jsonb),
 ('natstrat','nat-2',2,'{"demo":true,"name":"استراتيجية قطاع التنمية الاجتماعية","owner":"وزارة الموارد البشرية","domain":"القطاع الصحي","stage":3,"tech":false,"meas":46,"note":"امتثال ٤٦٪ من العناصر — زُوِّدت الوزارة بالملاحظات","period":"٢٠٢٤ – ٢٠٣٠","approvedAt":"2026-05-12","kpisRep":9,"kpisTot":22,"initRep":14,"initTot":31,"current":"الملاحظات الفنية أُرسلت للوزارة وبانتظار المعالجة.","challenge":"نصف عناصر الاستراتيجية غير مرتبطة بمؤشرات قياس.","next":"استلام النسخة المعالَجة ومراجعتها فنياً.","support":"تحديد ممثل دائم من الوزارة للتواصل الفني.","updated":"2026-09-03"}'::jsonb),
 ('natstrat','nat-3',3,'{"demo":true,"name":"الاستراتيجية الوطنية للفضاء","owner":"وكالة الفضاء السعودية","domain":"الفضاء","stage":3,"tech":false,"meas":72,"note":"ملاحظات فنية على المؤشرات والمبادرات — زُوِّدت الجهة","period":"٢٠٢٣ – ٢٠٣٠","approvedAt":"2026-08-28","kpisRep":16,"kpisTot":24,"initRep":21,"initTot":29,"current":"معتمدة من اللجنة الاستراتيجية وقيد رفع قابلية القياس.","challenge":"بعض المبادرات بلا مؤشرات أداء مرتبطة.","next":"مراجعة المبادرات غير الممثَّلة مع الوكالة.","support":"جلسة فنية مشتركة خلال الربع القادم.","updated":"2026-08-28"}'::jsonb),
 ('natstrat','nat-4',4,'{"demo":true,"name":"الاستراتيجية الوطنية للتخصيص","owner":"المركز الوطني للتخصيص","domain":"التوطين","stage":4,"tech":true,"meas":100,"note":"لا توجد ملاحظات — قابلية القياس ١٠٠٪","period":"٢٠٢١ – ٢٠٣٠","approvedAt":"2026-02-19","kpisRep":21,"kpisTot":21,"initRep":18,"initTot":18,"current":"معتمدة من مجلس الوزراء وجميع عناصرها قابلة للقياس.","challenge":"لا يوجد.","next":"المتابعة الدورية للأداء الربعي.","support":"لا يوجد.","updated":"2026-08-20"}'::jsonb),
 ('natstrat','nat-5',5,'{"demo":true,"name":"استراتيجية المدينة المنورة","owner":"هيئة تطوير المدينة","domain":"الحج","stage":3,"tech":false,"meas":68,"note":"ملاحظات فنية بانتظار المعالجة","period":"٢٠٢٤ – ٢٠٣٠","approvedAt":"2026-06-30","kpisRep":13,"kpisTot":20,"initRep":11,"initTot":17,"current":"معتمدة من اللجنة وبانتظار معالجة الملاحظات الفنية.","challenge":"تأخر ورود الردود من الهيئة.","next":"متابعة أسبوعية حتى استلام النسخة المعالَجة.","support":"تحديد موعد نهائي للردّ.","updated":"2026-08-14"}'::jsonb),
 ...
 ('projects','prj-1',1,'{"demo":true,"name":"مشروع دعم وتفعيل وقياس الاستراتيجيات الوطنية والأداء المؤسسي","status":"جارٍ التنفيذ","planned":30,"actual":26,"period":"أبريل ٢٠٢٦ – سبتمبر ٢٠٢٧","months":18,"elapsed":6}'::jsonb),
